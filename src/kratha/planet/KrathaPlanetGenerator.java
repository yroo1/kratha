...
public class KrathaPlanetGenerator extends PlanetGenerator {
    ...
    public void getColor(Vec3 position, Color out) {
        Block block = rawHeight(position) < 0.35f ? KrathaEnv.krathagenDeep : rawHeight(position) < 0.45f ? KrathaEnv.krathagenFloor : rawHeight(position) < 0.5f ? KrathaEnv.krathiteKrathagen : rawHeight(position) < 0.55f ? KrathaEnv.krathiteFloor : rawHeight(position) < 0.62f ? KrathaEnv.terrastoneFloor : KrathaEnv.terrastoneEroded;
